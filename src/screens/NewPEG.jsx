...
export default function NewPEG() {
    ...
    React.useEffect(() => {
        ...
        setCustomers(["Customer1", "Customer2", "Customer3"]);
        setEvaluators(["Evaluator1", "Evaluator2", "Evaluator3"]);
    ...
    return (
        <div>
            ...
            <Flex flexDir="row" w="100vh">
                <Flex flexDir="column" w="60vh" marginRight="50">
                    ...
                    <FormControl id="organizational-assignment" padding="2" isDisabled>
                        ...
                        <Input type=""
                        value = {user.organizationalAssignment} />
                    </FormControl>
                ...
                <Flex flexDir="column" w="60vh">
                    <FormControl id="name-of-project" padding="2">
                        ...
                        <Select placeholder="Select project" ref={projectRef} onChange={(e) => setProjectID(e.target.value)}>
                            {projects.map((obj, i) => (
            ...
            <Button isFullWidth='true' leftIcon={<FaPaperPlane />} mt={3} onClick={() => sendNewPEG()}>
                Send PEG request
            </Button>
        </div>
    );
